...
void test_insertion_sort_sorted(void) {
    int a[4] = {1, 2, 3, 4};
    insertion_sort(a, 4);
    ASSERT_TRUE(is_sorted_asc(a, 4));
}

void test_insertion_sort_reversed(void) {
    int a[5] = {5, 4, 3, 2, 1};
    insertion_sort(a, 5);
    ASSERT_TRUE(is_sorted_asc(a, 5));
}

void test_insertion_sort_with_negatives(void) {
...
void run_insertion_sort_tests(void) {
    ...
    RUN_TEST(test_insertion_sort_sorted);
    RUN_TEST(test_insertion_sort_reversed);
    RUN_TEST(test_insertion_sort_with_negatives);
}